...
import vertexShader from "@/app/(homepage)/(material)/landscape/vertex.glsl"
import fragmentShader from "@/app/(homepage)/(material)/landscape/fragment.glsl"
...
export class LandscapeMaterial extends THREE.ShaderMaterial {
    ...
    updateCamera(newPosition: THREE.Vector3) {
        this.uniforms.cameraPosition = { value: newPosition }
    }
}