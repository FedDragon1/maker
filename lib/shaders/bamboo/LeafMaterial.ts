...
import fragmentShader from "@/lib/shaders/bamboo/leafFragment.glsl";
import vertexShader from "@/lib/shaders/bamboo/leafVertex.glsl";
...
const defaultUniforms: UniformVariable = {
    ...
    uStemWindSpeed: 0.1,
    uStemWindScale: 5,
    uStemOrigin: new THREE.Vector3(0, 0, 0),
}
